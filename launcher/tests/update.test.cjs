...
test("checksums and release URLs bind the exact expected asset", () => {
  ...
  assert.equal(
    validateReleaseAssetUrl(
      "https://github.com/cloverpray/codex-web-harness/releases/download/v1.2.0/launcher.zip",
      "1.2.0",
      "launcher.zip",
    ),
    "https://github.com/cloverpray/codex-web-harness/releases/download/v1.2.0/launcher.zip",
      ...
      fetchRelease: async () => {
        ...
        return {
          ...
          assets: [
            ...
            {
              name: "checksums.txt",
              browser_download_url: "https://github.com/cloverpray/codex-web-harness/releases/download/v1.2.0/checksums.txt",
            },
          ],
        };
      },
